    ...
    \end{center}
        ...
        \end{center}
            ...
            \begin{tcolorbox}[colback=blue!5!white,colframe=blue!50!black,title= 22. Ismertesse a bináris fák szerkezetét és tárolási lehetőségeit számítógépen!]
                ...
                \begin{center}
                    \begin{tabular}{ c c }
                        \fbox{\includegraphics [scale = 0.4] {23_2.png}} & \fbox{\includegraphics [scale = 0.333 ]{23_3.png}}
                    \end{tabular}
                \end{center}
                \begin{center}
                    \fbox{\includegraphics[scale = 0.45]{23_4.png}}
                \end{center}
            \end{tcolorbox}
...
void quickSort(int arr[], int low, int high) {
        if (low < high) {
            ...
            \begin{tcolorbox}[colback=blue!5!white,colframe=blue!50!black,title= 33. Ismertesse példával a bankár algoritmust!]
                                        ...
                                        \begin{center}
                                            \begin{tabular}{ c c }
                                                \fbox{\includegraphics [scale = 0.3165] {34_1.png}} & \fbox{\includegraphics [scale = 0.25 ]{34_2.png}}\\
                                                \fbox{\includegraphics [scale = 0.25] {34_3.png}} & \fbox{\includegraphics [scale = 0.2505 ]{34_4.png}}
                                            \end{tabular}
                                        \end{center}
                                        \begin{center}
                                            \fbox{\includegraphics[scale = 0.4]{34_5.png}}                            
                                        \end{center}
            \end{tcolorbox}

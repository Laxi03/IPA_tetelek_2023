...
for i from 0 to n - 1
    ...
    for j from 0 to n - i - 2
        ...
        if not swapped
            ...
            \begin{tcolorbox}[colback=blue!5!white,colframe=blue!50!black,title= 59. Milyen paraméter-átadást használ a C nyelv? Hogy tudja megváltoztatni a függvény a paraméterei értékét úgy{,} hogy a hívó folyamatban is a változtatott érték szerepeljen?]
